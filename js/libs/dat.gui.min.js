  ...
  return {
    ...
    each: function (a, d, f) {
      if (e && a.forEach === e) a.forEach(d, f);
       else if (a.length === a.length + 0) for (var b = 0, n = a.length; b < n; b++) {
...
dat.controllers.NumberControllerBox = function (e, a, c) {
  var d = function (f, b, e) {
    ...
    a.bind(this.__input, 'keydown', function (a) {
      if (a.keyCode === 13) l.__truncationSuspended = true,
      this.blur(),
...
dat.GUI = dat.gui.GUI = function (e, a, c, d, f, b, n, h, j, m, l, o, y, g, i) {
  function q(a, b, r, c) {
    ...
    c.color ? b = new l(b, r)  : (b = [
      b,
      r
    ].concat(c.factoryArgs), b = d.apply(a, b));
  ...
  function p(a, d, c) {
    ...
    i.extend(c, {
      options: function (b) {
        ...
        if (i.isArray(b) || i.isObject(b)) return c.remove(),
        q(a, c.object, c.property, {
          before: c.__li.nextElementSibling,
          factoryArgs: [
            b
    ...
    g.bind(d, 'mouseout', function () {
     ...
     else if (c instanceof l) g.addClass(d, 'color'),
  ...
  function t(a, b) {
    ...
    if (d != - 1) {
      ...
      if (c.load && c.load.remembered) {
        ...
        if (c[d] && c[d][b.property] !== void 0) d = c[d][b.property],
        b.initialValue = d,
        b.setValue(d)
      }
    }
  ...
  i.extend(k.prototype, {
    ...
    addFolder: function (a) {
      ...
      if (this.load && this.load.folders && this.load.folders[a]) b.closed = this.load.folders[a].closed,
    ...
    remember: function () {
      if (i.isUndefined(x)) x = new y,
      x.domElement.innerHTML = a;
  ...
  function f(a, b, c) {
    Object.defineProperty(a, b, {
      ...
      set: function (a) {
        if (this.__state.space !== 'RGB') n(this, b, c),
  ...
  function b(a, b) {
    Object.defineProperty(a, b, {
      ...
      set: function (a) {
        if (this.__state.space !== 'HSV') h(this),
